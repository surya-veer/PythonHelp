...
class Chat(QDialog):
	...
	def __init__(self , parent = None):
		...
		self.offlineBtn.setText('Refresh')
		self.offlineBtn.setGeometry(225+360,435,100,40)

		self.refreshBtn = QPushButton(self)
		self.refreshBtn.setText('Go Offline')
		self.refreshBtn.setGeometry(225+360+100,435,100,40)
		# self.refreshBtn.clicked.connect(self.out.setText('<<welcome to my chat box>>'))
		...
		#create new server
		self.createServerBtn = QPushButton(self)
		self.createServerBtn.setText('Create new Server')
		self.createServerBtn.setGeometry(10,375,200,30)
		self.createServerBtn.clicked.connect(self.CreateServer)
		

		#how to use
		self.howBtn = QPushButton(self)
		self.howBtn.setText('how to use?')
		self.howBtn.setGeometry(10,410,200,30)
...
class ServerDlg(QPushButton):
    ...
    def __init__(self, parent=None):
        ...
        self.tcpServer.listen(QHostAddress("0.0.0.0"), 5555)
